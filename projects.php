    ...
    <div class="projects-grid">
        ...
        <div class="project-card">
            ...
            <div class="project-content">
                <h3 class="project-title">E-commerce Application</h3>
                <p class="project-description">
                    Modern online commerce platform with shopping cart, payments, and order management.
                </p>
        ...
        <div class="project-card">
            ...
            <div class="project-content">
                ...
                <p class="project-description">
                    Interactive dashboard to visualize and analyze real-time data.
                </p>
                <div class="project-tech">
                    <span class="tech-badge">React</span>
        ...
        <div class="project-card">
            ...
            <div class="project-content">
                <h3 class="project-title">Social Mobile App</h3>
                <p class="project-description">
                    Social networking application with instant messaging and content sharing.
                </p>
                <div class="project-tech">
        ...
        <div class="project-card">
            ...
            <div class="project-content">
                <h3 class="project-title">AI Chatbot Platform</h3>
                <p class="project-description">
                    Intelligent chatbot platform powered by AI for customer support automation.
                </p>
                <div class="project-tech">
        ...
        <div class="project-card">
            ...
            <div class="project-content">
                <h3 class="project-title">Portfolio Website Builder</h3>
                <p class="project-description">
                    Easy-to-use portfolio website builder with customizable templates.
                </p>
                <div class="project-tech">
                    <span class="tech-badge">Next.js</span>
                    <span class="tech-badge">Tailwind</span>
